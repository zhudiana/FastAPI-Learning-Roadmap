...
We’ll define a [**dependency**](https://github.com/zhudiana/FastAPI-Learning-Roadmap/blob/main/11-core-concepts/11.01-dependency-injection.md) that manages the database session, and then use it in our GET endpoint so that we don’t repeat code across multiple routes.
