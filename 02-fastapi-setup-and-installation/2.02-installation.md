...
Create and activate a [virtual environment](https://github.com/zhudiana/FastAPI-Learning-Roadmap/blob/main/01-python-fundamentals/1.06-virtual-environments.md) and then install FastAPI:
